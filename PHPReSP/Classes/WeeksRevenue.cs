    ...
    class WeeksRevenue
    {
        ...
        public void PopulateLists()
        {
           ...
           "server=localhost;uid=root;pwd=password;database=phpsreps_db");
            ...
            MySqlCommand cmd = new MySqlCommand("SELECT week(sales.SaleDate) AS Week, SUM(sales.NumberSold * products.Price) AS Revenue FROM sales INNER JOIN Products ON Products.productID = sales.ProductID GROUP BY Week ORDER BY sales.SaleDate; ", connection);
